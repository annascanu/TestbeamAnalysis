...
{
    std::string filename = "/home/riccardo-speziali/Scrivania/bin_file_july2026/Run"+std::to_string(run_number)+"_true/sampic_run1/sampic_run1/feb" + std::to_string(feb_number) + "/sampic_run1_feb" + std::to_string(feb_number) + ".bin";
    ...
    std::filesystem::create_directories("/home/riccardo-speziali/Scrivania/git/TestbeamAnalysis/sampic2root_july2026/root_file/run" + std::to_string(run_number));
    TString outfile_name = "/home/riccardo-speziali/Scrivania/git/TestbeamAnalysis/sampic2root_july2026/root_file/run" + std::to_string(run_number) + "/sampic_run1_feb"+std::to_string(feb_number)+"_Corr.root";
...
std::vector<WaveformRecord> read_waveform_file(const std::string& filename, int& run_number, int& feb_number) 
{
    ...
    double periodFactor = getPeriodFactor("/home/riccardo-speziali/Scrivania/bin_file_july2026/Run"+std::to_string(run_number)+"_true/sampic_run1/sampic_run1/Run_Settings.txt");
    ...
    while (file) 
    {
        ...
        {
            timestamp_ov++;
            cout<< "Timestamp overflow detected. Overflow count: " << timestamp_ov << std::endl;
        }
        ...
        // probavbly version
        //record.Cell0TimeStamp_corr = (timestamp_ov * TIMESTAMP_MAX+timestampRaw) * periodFactor;
