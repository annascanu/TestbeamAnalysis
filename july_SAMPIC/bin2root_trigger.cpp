...
int main(int argc, char* argv[]) 
{
    ...
    std::string filename = "/home/riccardo-speziali/Scrivania/bin_file_july2026/Run"+std::to_string(run_number)+"_true/sampic_run1/sampic_run1/sampic_run1_trigger_data.bin";
