...
int main()
{
    ...
    Double_t pulses_amplitude[MAXPULSES], pulses_integral[MAXPULSES], pulses_time_cfd10[MAXPULSES], pulses_time_cfd20[MAXPULSES], pulses_time_cfd30[MAXPULSES], integral[MAXPULSES];
    ...
    //     Save everything
    // -----------------------
    TFile *fout = new TFile("muon_run_cut_analysis.root", "RECREATE");
    hAmpAll->Write();
    hAmp1Hit->Write();
    hQ->Write();
    hTime->Write();
    ...
    cout << "Analysis complete. Results saved to muon_run_test_analysis.root" << endl;
