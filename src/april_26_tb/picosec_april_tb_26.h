...
struct Histograms {
    ...
    // Hit maps
    TH2F *mapdet1, *mapdet2, *mapdet3, *mapdet1_afterselection, *mapdet2_afterselection, *mapdet3_afterselection;
...
struct TreeBranches {
    ...
    Double_t pulses_channel_y[MAXPULSES];
